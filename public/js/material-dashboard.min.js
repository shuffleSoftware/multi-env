...
const tooltipList = tooltipTriggerList.map(function(e) {
...
function sidebarColor(e) {
  ...
  var e = e.getAttribute('data-color');
...
function navbarBlurOnScroll(e) {
  ...
  const n = ['blur', 'shadow-blur', 'left-auto'];
  const a = ['shadow-none'];
  function i() {
  ...
  function r(e) {
    const t = document.querySelectorAll('.navbar-main .nav-link');
...
function initNavs() {
  total.forEach(function(i, e) {
    ...
    (i.onmouseover = function(e) {
      ...
      if (a) {
        const s = Array.from(a.closest('ul').children);
        const n = s.indexOf(a) + 1;
...
window.addEventListener('resize', function(e) {
  total.forEach(function(s, e) {
    ...
    let a = s.querySelector('.nav-link.active').cloneNode();
    (a.innerHTML = '-'),
      ...
      window.innerWidth < 991 ?
        total.forEach(function(n, e) {
          if (!n.classList.contains('flex-column')) {
            ...
            const e = n.querySelector('.nav-link.active').parentElement;
            const t = Array.from(e.closest('ul').children);
            t.indexOf(e);
            let s = 0;
            for (let a = 1; a <= t.indexOf(e); a++) {
              s += n.querySelector('li:nth-child(' + a + ')').offsetHeight;
            }
            const i = document.querySelector('.moving-tab');
            (i.style.width =
        ...
        total.forEach(function(n, e) {
          if (n.classList.contains('on-resize')) {
            ...
            let s = 0;
            for (let i = 1; i <= t.indexOf(e); i++) {
              s += n.querySelector('li:nth-child(' + i + ')').offsetWidth;
            }
            const l = document.querySelector('.moving-tab');
...
function darkMode(e) {
  ...
  const n = document.querySelectorAll('div:not(.bg-gradient-dark) hr');
  const a = document.querySelectorAll('button:not(.btn) > .text-dark');
  const i = document.querySelectorAll('span.text-dark, .breadcrumb .text-dark');
  const l = document.querySelectorAll('span.text-white, .breadcrumb .text-white');
  const r = document.querySelectorAll('strong.text-dark');
  const o = document.querySelectorAll('strong.text-white');
  const c = document.querySelectorAll('a.nav-link.text-dark');
  const d = document.querySelectorAll('a.nav-link.text-white');
  const u = document.querySelectorAll('.text-secondary');
  const f = document.querySelectorAll('.bg-gray-100');
  const g = document.querySelectorAll('.bg-gray-600');
  ...
  const h = document.querySelectorAll('.card.border');
  const b = document.querySelectorAll('.card.border.border-dark');
  const L = document.querySelectorAll('g');
