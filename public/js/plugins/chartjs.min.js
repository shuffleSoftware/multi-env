...
!(function(t, e) {
  ...
  const o = (t, e, i) => ('start' === t ? e : 'end' === t ? i : (e + i) / 2);
  const s = (t, e, i) => ('right' === t ? i : 'center' === t ? (e + i) / 2 : e);
  const a = new (class {
    constructor() {
      (this._request = null),
  ...
  function Ut(t, e, i) {
    ...
    const o = 0 !== i ? Math.max(i / 2, 0.5) : 0;
  ...
  const ne = (t, e, i) => ee(t, i, (n) => t[n][e] >= i);
  function oe(t, e, i) {
    let n = 0;
    let o = t.length;
    for (; n < o && t[n] < e; ) n++;
  ...
  function pe(t, e) {
    ...
    const o = de(i);
    const s = 'border-box' === o.boxSizing;
    const a = ge(o, 'padding');
    const r = ge(o, 'border', 'width');
    const {
      x: l,
      y: c,
      box: h,
  ...
  function xe(t, e, i, n) {
    const o = de(t);
    const s = ge(o, 'margin');
    const a = he(o.maxWidth, t, 'clientWidth') || yt;
    const r = he(o.maxHeight, t, 'clientHeight') || yt;
    const l = (function(t, e, i) {
      ...
      if (void 0 === e || void 0 === i) {
        ...
        if (s) {
          ...
          const a = de(s);
          const r = ge(a, 'border', 'width');
          const l = ge(a, 'padding');
  ...
  function Me(t, e, i, n) {
    ...
    if (r && e === r.axis && a && s.length) {
      ...
      if (o._sharedOptions) {
        const n = s[0];
        const o = 'function' == typeof n.getRange && n.getRange(e);
        if (o) {
          const n = t(s, e, i - o);
          const a = t(s, e, i + o);
  ...
  const De = {
    modes: {
      index(t, e, i, n) {
        const o = ve(e, t);
        const s = i.axis || 'x';
        const a = i.intersect ? ke(t, o, s, n) : Se(t, o, s, !1, n);
        const r = [];
        return a.length ?
  ...
  function je(t, e, i) {
    ...
    const a = Math.max(0, e.outerHeight - He(o, t, 'top', 'bottom'));
    const r = s !== t.w;
    const l = a !== t.h;
    return (
      (t.w = s),
  ...
  function Ye(t, e, i) {
    const n = [];
    let o; let s; let a; let r; let l; let c;
  ...
  const Xe = {
    ...
    update(t, e, i, n) {
      ...
      const r = (function(t) {
        ...
        const n = We(Ve(e, 'left'), !0);
        const o = We(Ve(e, 'right'));
        const s = We(Ve(e, 'top'), !0);
        const a = We(Ve(e, 'bottom'));
        const r = Be(e, 'x');
        const l = Be(e, 'y');
        return {
          fullSize: i,
  ...
  class li extends qe {
    ...
    addEventListener(t, e, i) {
      ...
      const o = {attach: ti, detach: ei, resize: si}[e] || ri;
      n[e] = o(t, e, i);
    }
  ...
  const ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * bt) / i) + 1;
  const fi = {
    linear: (t) => t,
    easeInQuad: (t) => t * t,
    easeOutQuad: (t) => -t * (t - 2),
  ...
  const gi = 'transparent';
  const pi = {
    boolean: (t, e, i) => (i > 0.5 ? e : t),
    color(t, e, i) {
      const n = W(t || gi);
      const o = n.valid && W(e || gi);
  ...
  function vi(t, e, i, n) {
    const o = t.keys;
    const s = 'single' === n.mode;
    let a; let r; let l; let c;
    if (null !== e) {
  ...
  const Ci = (t, e) => (e ? t : Object.assign({}, t));
  class Ai {
    constructor(t, e) {
      (this.chart = t),
      (this._ctx = t.ctx),
    ...
    linkScales() {
      ...
      const o = (t, e, i, n) => ('x' === t ? e : 'r' === t ? n : i);
      const s = (i.xAxisID = K(n.xAxisID, Si(e, 'x')));
      const a = (i.yAxisID = K(n.yAxisID, Si(e, 'y')));
      const r = (i.rAxisID = K(n.rAxisID, Si(e, 'r')));
      const l = i.indexAxis;
    ...
    parse(t, e) {
      ...
      let c;
      let h;
      let d = (0 === t && e === o.length) || n._sorted;
    ...
    getMinMax(t, e) {
      ...
      const l = e && n._stacked && {keys: yi(i.chart, !0), values: null};
  ...
  class ji extends Oi {
    ...
    calculateLabelRotation() {
      ...
      const f = Ht(t.chart.width - d, 0, t.maxWidth);
    ...
    _calculatePadding(t, e, i, n) {
      ...
      const l = 0 !== o.labelRotation;
      const c = 'top' !== r && 'x' === o.axis;
      if (o.isHorizontal()) {
    ...
    _computeGridLineItems(t) {
      ...
      let m; let x; let b; let _; let y; let v; let M; let w; let k; let S; let P; let D;
      if ('top' === a) {
        (m = p(e.bottom)),
        (v = e.bottom - h),
        (w = m - g),
    ...
    _computeLabelItems(t) {
      ...
      const r = e.ticks;
      const {align: l, crossAlign: c, padding: h} = s;
      const d = Wi(n.grid);
      const u = d + h;
      const f = -Rt(e.labelRotation);
      const g = [];
      let p;
      let m;
      let x;
    ...
    drawGrid(t) {
      ...
      const n = e.ctx;
      const o = e.chart;
      const s = i.setContext(e.getContext(0));
      ...
      if (a) {
        ...
        const n = t.lineWidth;
        const s = e._borderValue;
        let r; let l; let c; let d;
        e.isHorizontal() ?
          ((r = Ut(o, e.left, a) - a / 2),
  ...
  const sn = (t, e) => e < t.length && !t[e].skip && t[e];
  function an(t, e, i, n) {
    const o = t.skip ? e : t;
    const s = e;
    const a = i.skip ? e : i;
  ...
  function bn(t, e, i) {
    ...
    const a = e.length;
    const {compare: r, between: l, normalize: c} = mn(n);
    const {
      start: h,
      end: d,
      loop: u,
      ...
      const {property: n, start: o, end: s} = i;
      const {between: a, normalize: r} = mn(n);
      const l = e.length;
      let c;
      let h;
  ...
  function yn(t) {
    const e = t.points;
    const i = t.options.spanGaps;
    const n = e.length;
    if (!n) return [];
    const o = !!t._loop;
    const {start: s, end: a} = (function(t, e, i, n) {
      let o = 0;
      let s = e - 1;
  ...
  class kn {
    ...
    _createDescriptors(t, e) {
      ...
      const o = (function(t) {
        const e = [];
        const i = Object.keys(wn.plugins.items);
  ...
  class En {
    ...
    resolveNamedOptions(t, e, i, n = ['']) {
      const o = {$shared: !0};
      const {resolver: s, subPrefixes: a} = In(this._resolverCache, t, n);
      let r = s;
      if (
        (function(t, e) {
  ...
  class eo extends Ai {
    ...
    parseObjectData(t, e, i, n) {
      const {iScale: o, vScale: s} = t;
      const {xAxisKey: a = 'x', yAxisKey: r = 'y'} = this._parsing;
      const l = 'x' === o.axis ? a : r;
      const c = 'x' === s.axis ? a : r;
      const h = [];
      let d; let u; let f; let g;
      for (d = i, u = i + n; d < u; ++d) {
        (g = e[d]),
        (f = {}),
    ...
    updateElements(t, e, i, n) {
      ...
      for (let a = e; a < e + i; a++) {
        ...
        const i = o._calculateBarIndexPixels(a, c);
        const h = {
          horizontal: l,
          base: e.base,
          x: l ? e.head : i.center,
  ...
  class no extends Ai {
    ...
    getLabelAndValue(t) {
      ...
      const o = Li(e._parsed[t], i.options.locale);
  ...
  class oo extends Ai {
    ...
    updateElements(t, e, i, n) {
      ...
      const f = At(u) ? u : Number.POSITIVE_INFINITY;
      const g = o.chart._animationsDisabled || s || 'none' === n;
      let p = e > 0 && o.getParsed(e - 1);
      for (let c = e; c < e + i; ++c) {
        const e = t[c];
        const i = o.getParsed(c);
        const u = g ? e : {};
        const m = (u.x = a.getPixelForValue(i.x, c));
        const x = (u.y = s ?
            r.getBasePixel() :
  ...
  function fo(t, e) {
    ...
    const l = e.outerRadius;
    const c = e.innerRadius + a;
    const h = 'inner' === r.borderAlign;
    r.borderWidth &&
      (h ?
  ...
  function mo(t, e, i) {
    i = i || {};
    const n = t.length;
    const o = Math.max(i.start || 0, e.start);
    const s = Math.min(i.end || n - 1, e.end);
    return {
      count: n,
      start: o,
      loop: e.loop,
  ...
  function xo(t, e, i, n) {
    ...
    const {count: a, start: r, loop: l, ilen: c} = mo(o, i, n);
    const h = (function(t) {
  ...
  function bo(t, e, i, n) {
    const o = e.points;
    const {count: s, start: a, ilen: r} = mo(o, i, n);
  ...
  class vo extends Oi {
    ...
    interpolate(t, e) {
      ...
      const o = t[e];
      const s = i.points;
      const a = _n(i, {property: e, start: o, end: o});
      if (!a.length) return;
      const r = [];
      const l = (function(t) {
          ...
          case 'lttb':
            h = (function(t, e, i) {
              ...
              for (o[d++] = t[u], a = 0; a < n - 2; a++) {
                ...
                const g = Math.min(Math.floor((a + 2) * s) + 1, t.length);
                const p = g - f;
                for (e = f; e < g; e++) (i = t[e].x), (n = t[e].y);
                (i /= p), (n /= p);
                const m = Math.floor(a * s) + 1;
                const x = Math.floor((a + 1) * s) + 1;
                const {x: b, y: _} = t[u];
                for (l = c = -1, e = m; e < x; e++) {
                  (c =
                    0.5 *
...
s < h ? ((h = s), (r = i)) : s > d && ((d = s), (l = i)),
  ...
  function Zo(t, e) {
    ...
    const r = (function(t, e, i) {
      ...
      for (let t = 0; t < n.length; t++) {
        const r = n[t];
        const l = Xo(i, o[r.start], o[r.end], r.loop);
        if (!e.segments) {
        ...
        for (let t = 0; t < c.length; ++t) {
          const e = c[t];
          const n = Xo(i, s[e.start], s[e.end], e.loop);
          const h = bn(r, o, n);
  ...
  const Qo = {
    ...
    beforeDatasetDraw(t, e) {
      ...
      const {line: a, scale: r} = o;
      const l = a.options;
      const c = l.fill;
      const h = l.backgroundColor;
      const {above: d = h, below: u = h} = c || {};
      s &&
        a.points.length &&
        (Gt(n, i),
        (function(t, e) {
  ...
  class ts extends Oi {
    ...
    fit() {
      ...
      const {boxWidth: r, itemHeight: l} = Jo(n, s);
      let c; let h;
      (i.font = o.string),
        t.isHorizontal() ?
    ...
    _draw() {
      ...
      const c = mt.color;
      const h = fn(e.rtl, t.left, t.width);
      const d = Ee(l.font);
      ...
      t.legendItems.forEach((e, u) => {
        ...
        const k = h.textAlign(e.textAlign || (e.textAlign = l.textAlign));
        const S = x + g / 2 + w;
        let P = m.x;
        let D = m.y;
        h.setWidth(t.width),
  ...
  function ls(t, e) {
    ...
    const l = Ee(e.bodyFont);
    const c = Ee(e.titleFont);
    const h = Ee(e.footerFont);
    const d = s.length;
    const u = o.length;
    const f = n.length;
    const g = Re(e.padding);
    let p = g.height;
    let m = 0;
    let x = n.reduce(
  ...
  class ps extends Oi {
    ...
    update(t, e) {
      ...
      if (o.length) {
        ...
        const l = hs(i._chart, n, r);
        const c = ds(n, r, l, i._chart);
        (i.xAlign = l.xAlign),
        (i.yAlign = l.yAlign),
        (s = {
          opacity: 1,
    ...
    getCaretPosition(t, e, i) {
      ...
      let d; let u; let f; let g; let p; let m;
      return (
        'center' === o ?
          ((p = l + h / 2),
            'left' === n ?
    ...
    drawBody(t, e, i) {
      ...
      let m; let x; let b; let _; let y; let v; let M;
      for (
        e.textAlign = a,
        e.textBaseline = 'middle',
        e.font = h.string,
    ...
    _positionChanged(t, e) {
      const i = this;
      const n = os[i.options.position].call(i, t, e);
      ...
      e.display && e.pointLabels.display ?
        (function(t) {
          ...
          for (n = 0; n < l; n++) {
            ...
            const g = Et(f);
            const p = Ss(g, s.x, o.w, 0, 180);
            const m = Ss(g, s.y, o.h, 90, 270);
  ...
  class Vs extends ji {
    ...
    init(t, e) {
      ...
      const n = (this._adapter = new Gn._date(t.adapters.date));
    ...
    buildTicks() {
      ...
      const i = e.time;
      const n = e.ticks;
      const o = 'labels' === n.source ? t.getLabelTimestamps() : t._generate();
      'ticks' === e.bounds &&
        o.length &&
        ((t.min = t._userMin || o[0]), (t.max = t._userMax || o[o.length - 1]));
      const s = t.min;
      const a = oe(o, s, t.max);
      return (
        (t._unit =
          i.unit ||
          (n.autoSkip ?
    ...
    _generate() {
      ...
      const o = t.options;
      const s = o.time;
      const a = s.unit || Is(s.minUnit, i, n, t._getLabelCapacity(i));
      const r = K(s.stepSize, 1);
      const l = 'week' === a && s.isoWeekday;
      const c = At(l) || !0 === l;
      const h = {};
      let d;
      let u;
    ...
    _getLabelSize(t) {
      ...
      const o = Rt(e.isHorizontal() ? i.maxRotation : i.minRotation);
      const s = Math.cos(o);
      const a = Math.sin(o);
    ...
    _getLabelCapacity(t) {
      ...
      const s = e._tickFormatFunction(t, 0, zs(e, [t], e._majorUnit), o);
