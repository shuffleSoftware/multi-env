!(function(t, e) {
        ...
        value: function(t) {
          ...
          for (var e = Object(t), i = 1; i < arguments.length; i++) {
            ...
            if (null != s) {
              s = Object(s);
              for (
                let a = Object.keys(Object(s)), r = 0, n = a.length;
                r < n;
                r++
              ) {
                const o = a[r];
  ...
  const v = (function() {
    ...
    return (
      ...
      (e.set = function(t, e) {
        if (f.isObj(t)) for (const i in t) this.applyAttr(i, t[i]);
  ...
  function k(t, e, i) {
    const s = f.$(e);
    const a = -1 === s.attr('class').indexOf('jvm-region') ? 'marker' : 'region';
    const r = 'region' === a ? s.attr('data-code') : s.attr('data-index');
    let n = a + ':select';
    return (
      i && (n = a + '.tooltip:show'),
      {
  ...
  const L = (function() {
    ...
    return (
      (e.setMinMaxValues = function(t) {
        for (let e in ((this.min = Number.MAX_VALUE), (this.max = 0), t)) {
  ...
  const T = Object.freeze({
    ...
    createLines: function(t, e, i) {
      ...
      let r = !1;
      let n = !1;
      for (const o in ((this.linesGroup =
    ...
    createSeries: function() {
      ...
      this.params.series)) {
        for (let e = 0; e < this.params.series[t].length; e++) {
          this.series[t][e] = new X(this.params.series[t][e], this[t], this);
        }
      }
    },
    applyTransform: function() {
      let t; let e; let i; let s;
  ...
  var z = (function() {
    ...
    return (
      ...
      (e.reset = function() {
        for (const t in this.series) {
          for (let e = 0; e < this.series[t].length; e++) {
