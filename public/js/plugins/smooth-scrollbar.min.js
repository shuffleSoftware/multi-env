  ...
  return (function(t) {
    ...
    function(t, n, e) {
      ...
      var s = function(t, n, e) {
        ...
        const y = t & s.P;
        const m = t & s.B;
        const g = d ? r : v ? r[n] || (r[n] = {}) : (r[n] || {}).prototype;
        const b = d ? o : o[n] || (o[n] = {});
    ...
    function(t, n, e) {
      ...
      t.exports = function(t, n, e, d, v, y, m) {
        ...
        let S = !1;
        var O = t.prototype;
        const T = O[l] || O['@@iterator'] || (v && O[v]);
        let A = T || _(v);
        const M = v ? (E ? _('entries') : A) : void 0;
        const P = ('Array' == n && O.entries) || T;
        if (
          (P &&
    ...
    function(t, n, e) {
      'use strict';
      (function(t) {
        const e = 'object' == typeof t && t && t.Object === Object && t;
        n.a = e;
      }.call(this, e(99)));
    },
    function(t, n, e) {
    ...
    function(t, n, e) {
      const r = e(2).document;
      t.exports = r && r.documentElement;
    },
    function(t, n, e) {
      const r = e(9);
      const o = e(20);
      const i = e(32)('IE_PROTO');
    ...
    function(t, n, e) {
      ...
      const b = (t.exports = e(37)('WeakMap', m, g, a, !0, !0));
      p &&
        h &&
      ...
      o(
          ...
          'Array',
          {
            from: function(t) {
              ...
              let l;
              const p = i(t);
              const h = 'function' == typeof this ? this : Array;
...
***************************************************************************** */
      ...
      const f = s.a || a || Function('return this')();
      const l = f.Symbol;
      const p = Object.prototype;
      const h = p.hasOwnProperty;
      const d = p.toString;
      const v = l ? l.toStringTag : void 0;
      const y = Object.prototype.toString;
      const m = l ? l.toStringTag : void 0;
      const g = function(t) {
        return null == t ?
            void 0 === t ?
              '[object Undefined]' :
                  ...
                  Object.defineProperty(this, e, {
                    value: k.apply(
                        ...
                        (function() {
                          ...
                          for (n = 0; n < e; n++) {
                            for (
                              let i = arguments[n], u = 0, c = i.length;
                              u < c;
                              u++, o++
                            ) {
                              r[o] = i[u];
      ...
      const W = ['webkit', 'moz', 'ms', 'o'];
      const H = new RegExp('^-(?!(?:' + W.join('|') + ')-)');
      function B(t, n) {
        (n = (function(t) {
          const n = {};
          return (
        ...
        Object.keys(n).forEach(function(e) {
          const r = e.replace(/^-/, '').replace(/-([a-z])/g, function(t, n) {
      ...
      const X = (function() {
        ...
        return (
          (t.prototype.update = function(t) {
            const n = this.velocity;
            const e = this.updateTime;
            const r = this.lastPosition;
            const o = Date.now();
            const i = F(t);
            const u = {x: -(i.x - r.x), y: -(i.y - r.y)};
            const c = o - e || 16;
            const s = (u.x / c) * 16;
            const a = (u.y / c) * 16;
            (n.x = 0.9 * s + 0.1 * n.x),
      ...
      const V = (function() {
        ...
        return (
          ...
          (t.prototype.getDelta = function() {
            const t = this._getActiveTracker();
      ...
      const q = (function() {
        function t(t) {
          this._scrollbar = t;
          const n = t.options.thumbMinSize;
      ...
      const nt = {order: new Set(), constructors: {}};
      function et(t) {
        const n = R(t);
      ...
      function ut(t) {
        let n;
        const e = /Android/.test(navigator.userAgent) ? 3 : 2;
        const r = t.options.delegateTo || t.containerEl;
        const o = new V();
        const i = R(t);
        let u = 0;
      ...
      const pt = (function() {
        function t(t, n) {
          ...
          (this.containerEl = t);
          const r = (this.contentEl = document.createElement('div'));
          ...
          (this._plugins = (function(t, n) {
            return Array.from(nt.order)
                ...
                .map(function(e) {
                  const r = new (0, nt.constructors[e])(t, n[e]);
        ...
        return (
          Object.defineProperty(t.prototype, 'parent', {
            get: function() {
              for (let t = this.containerEl.parentElement; t; ) {
                const n = lt.get(t);
                if (n) return n;
                t = t.parentElement;
              }
          ...
          (t.prototype.update = function() {
            !(function(t) {
              ...
              const r = t.containerEl.getBoundingClientRect();
              const o = {
          ...
          (t.prototype.isVisible = function(t) {
            return (function(t, n) {
              ...
              const o = Math.max(e.top, r.top);
              const i = Math.max(e.left, r.left);
              const u = Math.min(e.right, r.right);
          ...
          (t.prototype.scrollIntoView = function(t, n) {
            ...
            (function(t, n, e) {
              const r = void 0 === e ? {} : e;
              const o = r.alignToTop;
              const i = void 0 === o || o;
              const u = r.onlyScrollIfNeeded;
              const c = void 0 !== u && u;
              const s = r.offsetTop;
              const a = void 0 === s ? 0 : s;
              const f = r.offsetLeft;
              const l = void 0 === f ? 0 : f;
              const p = r.offsetBottom;
              const h = void 0 === p ? 0 : p;
              const d = t.containerEl;
              const v = t.bounding;
              const y = t.offset;
              const m = t.limit;
              if (n && d.contains(n)) {
                ...
                if (!c || !t.isVisible(n)) {
                  const b = i ? g.top - v.top - a : g.bottom - v.bottom + h;
          ...
          (t.prototype.addTransformableMomentum = function(t, n, e, r) {
            ...
            const o = this._plugins.reduce(
                function(t, n) {
                  return n.transformDelta(t, e) || t;
                },
                {x: t, y: n},
            );
            const i = !this._shouldPropagateMomentum(o.x, o.y);
          ...
          (t.prototype._shouldPropagateMomentum = function(t, n) {
            ...
            const i = O(t + r.x, 0, o.x);
            const u = O(n + r.y, 0, o.y);
            let c = !0;
            return (
              (c = (c = c && i === r.x) && u === r.y) &&
          ...
          (t.prototype._render = function() {
            const t = this._momentum;
            if (t.x || t.y) {
              const n = this._nextTick('x');
              const e = this._nextTick('y');
              (t.x = n.momentum),
              (t.y = e.momentum),
              this.setPosition(n.position, e.position);
            }
            const r = i({}, this._momentum);
            this._plugins.forEach(function(t) {
              t.onRender(r);
            }),
      ...
      const ht = 'smooth-scrollbar-style';
      let dt = !1;
      function vt() {
