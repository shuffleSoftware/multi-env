 ...
 */ (function(a, b) {
  ...
  const C = {isEmpty: {configurable: !0}};
  ...
  const G = {
    'click-rail': function(a) {
      ...
      a.event.bind(a.scrollbarXRail, 'mousedown', function(b) {
        ...
        const d = c > a.scrollbarXLeft ? 1 : -1;
    ...
    'wheel': function(b) {
      function c(a, c) {
        let d;
        const e = v(h.scrollTop);
        const f = 0 === h.scrollTop;
        const g = e + h.offsetHeight === h.scrollHeight;
        const i = 0 === h.scrollLeft;
        const j = h.scrollLeft + h.offsetWidth === h.scrollWidth;
        return (
          (d = u(c) > u(a) ? f || g : i || j),
    ...
    'touch': function(b) {
      ...
      function j(a) {
        if (g(a)) {
          const b = f(a);
          const e = {pageX: b.pageX, pageY: b.pageY};
          const h = e.pageX - m.pageX;
          const j = e.pageY - m.pageY;
