...
!(function(e, t) {
  ...
  function b(e, n) {
    ...
    void 0 === n && (n = []);
    const o = y(e);
    const i = o === (null == (r = e.ownerDocument) ? void 0 : r.body);
    const a = t(o);
  ...
  function O(e) {
    ...
    return i &&
      ...
      i ||
          (function(e) {
            const t = -1 !== navigator.userAgent.toLowerCase().indexOf('firefox');
            if (
    ...
    return r === W ?
      ...
      V(
          (function(e) {
            ...
            const n = u(e);
            const r = c(e);
            const o = null == (t = e.ownerDocument) ? void 0 : t.body;
            const a = i(
                n.scrollWidth,
                n.clientWidth,
                o ? o.scrollWidth : 0,
  ...
  function Y(e, t) {
    ...
    const y = z('number' != typeof g ? g : X(g, P));
    ...
    const L = U({reference: A, element: x, strategy: 'absolute', placement: i});
  ...
  function te(e) {
    ...
    const y = f.y;
    let b = void 0 === y ? 0 : y;
    const x = 'function' == typeof h ? h({x: g, y: b}) : {x: g, y: b};
    (g = x.x), (b = x.y);
  ...
  const le = {
    ...
    fn: function(e) {
      ...
      const b = Y(t, {boundary: p, rootBoundary: u, padding: d, altBoundary: l});
      ...
      if (W) {
        if (s) {
          ...
          const se = ae ? ('y' === P ? ae.clientTop || 0 : ae.clientLeft || 0) : 0;
          const fe = null != (V = null == S ? void 0 : S[P]) ? V : 0;
          const ce = z + ie - fe;
        ...
        if (c) {
          ...
          const he = 'x' === P ? E : D;
          const me = W[k];
          const ve = 'y' === k ? 'height' : 'width';
          const ge = me + b[de];
          const ye = me - b[he];
          const be = -1 !== [j, A].indexOf(x);
          const xe = null != (le = null == S ? void 0 : S[k]) ? le : 0;
  ...
  const de = {
    ...
    fn: function(e) {
      ...
      if (i && a) {
        ...
        const g = O(i);
        const y = g ? ('y' === f ? g.clientHeight || 0 : g.clientWidth || 0) : 0;
        const b = h / 2 - m / 2;
        const x = p[l];
        const w = y - u[c] - p[d];
        const L = y / 2 - u[c] / 2 + b;
